...
const levels: Level[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        blocks: [
          {
            p: "The John 17 Landmark highlights Jesus’ prayer at the Last Supper. It stands as a public sign that Orthodox, Presbyterians, Methodists, Lutherans, Evangelicals, Armenians, Copts, Anglicans, Baptists, Pentecostals, Catholics, and many others can join in a visible act of collaboration.",
          },
          {
            scripture:
    ...
    pages: [
      {
        ...
        blocks: [
          ...
          {
            p: "By helping build the John 17 Landmark at Magdala, your faith community places a concrete sign of its faith on the shores of the Sea of Galilee. Pilgrims will see that your church did not merely speak about Christian oneness — it helped build a public witness to it.",
          },
        ],
      },
      {
